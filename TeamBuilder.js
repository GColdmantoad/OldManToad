...
function turn2() {
    ...
    <div class="moveOptions">
        <div class="btn" onclick="targetSelector(${vgcTeam[0].movePool[0]}, ${vgcTeam[0].id})">${vgcTeam[0].type1} attack</div>
        <div class="btn" onclick="targetSelector(${vgcTeam[0].movePool[1]}, ${vgcTeam[0].id})">${vgcTeam[0].type2} attack</div>
        <div class="btn">boost</div>
        <div class="btn" onclick="protect1()">protect</div>
        <div class="btn">switch</div>
    </div>`
